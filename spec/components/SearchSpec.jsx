describe ('Search', function() {
  ...
  describe('when rendering live data from YouTube', function() {
    ...
    it('should update the video list when typing into the input box', function() {
      var videoEntryTitleElements = scryRenderedDOMComponentsWithClass(app, 'video-list-entry-title');
      videoEntryTitleElements.forEach((videoEntryTitle, i) => {
        console.log('passing: videoEntryTitleHTML', videoEntryTitle.innerHTML );
        console.log('passing: moreFakeVideoData[i].snippet.title', moreFakeVideoData[i].snippet.title );
        expect(videoEntryTitle.innerHTML).to.equal(fakeVideoData[i].snippet.title);
      });
      ...
      newVideoEntryTitleElements.forEach((videoEntryTitle, i) => {
        console.log('videoEntryTitleHTML', videoEntryTitle.innerHTML );
        console.log('moreFakeVideoData[i].snippet.title', moreFakeVideoData[i].snippet.title );
